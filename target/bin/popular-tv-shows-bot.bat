...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="popular-tv-shows-bot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" MainClass %CMD_LINE_ARGS%
